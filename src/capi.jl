...
function sqlite3_extended_result_codes(arg1, onoff)
    @ccall libsqlite.sqlite3_extended_result_codes(arg1::Ptr{sqlite3}, onoff::Cint)::Cint
end

function sqlite3_last_insert_rowid(arg1)
    @ccall libsqlite.sqlite3_last_insert_rowid(arg1::Ptr{sqlite3})::sqlite3_int64
end

function sqlite3_set_last_insert_rowid(arg1, arg2)
    @ccall libsqlite.sqlite3_set_last_insert_rowid(arg1::Ptr{sqlite3}, arg2::sqlite3_int64)::Cvoid
end
...
function sqlite3_realloc64(arg1, arg2)
    @ccall libsqlite.sqlite3_realloc64(arg1::Ptr{Cvoid}, arg2::sqlite3_uint64)::Ptr{Cvoid}
end
...
function sqlite3_open(filename, ppDb)
    @ccall libsqlite.sqlite3_open(filename::Ptr{Cchar}, ppDb::Ptr{Ptr{sqlite3}})::Cint
end

function sqlite3_open16(filename, ppDb)
    @ccall libsqlite.sqlite3_open16(filename::Ptr{Cvoid}, ppDb::Ptr{Ptr{sqlite3}})::Cint
end
...
function sqlite3_uri_parameter(zFilename, zParam)
    @ccall libsqlite.sqlite3_uri_parameter(zFilename::Ptr{Cchar}, zParam::Ptr{Cchar})::Ptr{Cchar}
end
...
function sqlite3_database_file_object(arg1)
    @ccall libsqlite.sqlite3_database_file_object(arg1::Ptr{Cchar})::Ptr{sqlite3_file}
end
...
function sqlite3_limit(arg1, id, newVal)
    @ccall libsqlite.sqlite3_limit(arg1::Ptr{sqlite3}, id::Cint, newVal::Cint)::Cint
end
...
function sqlite3_bind_double(arg1, arg2, arg3)
    @ccall libsqlite.sqlite3_bind_double(arg1::Ptr{sqlite3_stmt}, arg2::Cint, arg3::Cdouble)::Cint
end

function sqlite3_bind_int(arg1, arg2, arg3)
    @ccall libsqlite.sqlite3_bind_int(arg1::Ptr{sqlite3_stmt}, arg2::Cint, arg3::Cint)::Cint
end
...
function sqlite3_bind_null(arg1, arg2)
    @ccall libsqlite.sqlite3_bind_null(arg1::Ptr{sqlite3_stmt}, arg2::Cint)::Cint
end
...
function sqlite3_bind_zeroblob(arg1, arg2, n)
    @ccall libsqlite.sqlite3_bind_zeroblob(arg1::Ptr{sqlite3_stmt}, arg2::Cint, n::Cint)::Cint
end
...
function sqlite3_bind_parameter_name(arg1, arg2)
    @ccall libsqlite.sqlite3_bind_parameter_name(arg1::Ptr{sqlite3_stmt}, arg2::Cint)::Ptr{Cchar}
end

function sqlite3_bind_parameter_index(arg1, zName)
    @ccall libsqlite.sqlite3_bind_parameter_index(arg1::Ptr{sqlite3_stmt}, zName::Ptr{Cchar})::Cint
end
...
function sqlite3_column_name(arg1, N)
    @ccall libsqlite.sqlite3_column_name(arg1::Ptr{sqlite3_stmt}, N::Cint)::Ptr{Cchar}
end

function sqlite3_column_name16(arg1, N)
    @ccall libsqlite.sqlite3_column_name16(arg1::Ptr{sqlite3_stmt}, N::Cint)::Ptr{Cvoid}
end

function sqlite3_column_database_name(arg1, arg2)
    @ccall libsqlite.sqlite3_column_database_name(arg1::Ptr{sqlite3_stmt}, arg2::Cint)::Ptr{Cchar}
end

function sqlite3_column_database_name16(arg1, arg2)
    @ccall libsqlite.sqlite3_column_database_name16(arg1::Ptr{sqlite3_stmt}, arg2::Cint)::Ptr{Cvoid}
end

function sqlite3_column_table_name(arg1, arg2)
    @ccall libsqlite.sqlite3_column_table_name(arg1::Ptr{sqlite3_stmt}, arg2::Cint)::Ptr{Cchar}
end

function sqlite3_column_table_name16(arg1, arg2)
    @ccall libsqlite.sqlite3_column_table_name16(arg1::Ptr{sqlite3_stmt}, arg2::Cint)::Ptr{Cvoid}
end

function sqlite3_column_origin_name(arg1, arg2)
    @ccall libsqlite.sqlite3_column_origin_name(arg1::Ptr{sqlite3_stmt}, arg2::Cint)::Ptr{Cchar}
end

function sqlite3_column_origin_name16(arg1, arg2)
    @ccall libsqlite.sqlite3_column_origin_name16(arg1::Ptr{sqlite3_stmt}, arg2::Cint)::Ptr{Cvoid}
end

function sqlite3_column_decltype(arg1, arg2)
    @ccall libsqlite.sqlite3_column_decltype(arg1::Ptr{sqlite3_stmt}, arg2::Cint)::Ptr{Cchar}
end

function sqlite3_column_decltype16(arg1, arg2)
    @ccall libsqlite.sqlite3_column_decltype16(arg1::Ptr{sqlite3_stmt}, arg2::Cint)::Ptr{Cvoid}
end
...
function sqlite3_column_blob(arg1, iCol)
    @ccall libsqlite.sqlite3_column_blob(arg1::Ptr{sqlite3_stmt}, iCol::Cint)::Ptr{Cvoid}
end

function sqlite3_column_double(arg1, iCol)
    @ccall libsqlite.sqlite3_column_double(arg1::Ptr{sqlite3_stmt}, iCol::Cint)::Cdouble
end

function sqlite3_column_int(arg1, iCol)
    @ccall libsqlite.sqlite3_column_int(arg1::Ptr{sqlite3_stmt}, iCol::Cint)::Cint
end

function sqlite3_column_int64(arg1, iCol)
    @ccall libsqlite.sqlite3_column_int64(arg1::Ptr{sqlite3_stmt}, iCol::Cint)::sqlite3_int64
end

function sqlite3_column_text(arg1, iCol)
    @ccall libsqlite.sqlite3_column_text(arg1::Ptr{sqlite3_stmt}, iCol::Cint)::Ptr{Cuchar}
end

function sqlite3_column_text16(arg1, iCol)
    @ccall libsqlite.sqlite3_column_text16(arg1::Ptr{sqlite3_stmt}, iCol::Cint)::Ptr{Cvoid}
end

function sqlite3_column_value(arg1, iCol)
    @ccall libsqlite.sqlite3_column_value(arg1::Ptr{sqlite3_stmt}, iCol::Cint)::Ptr{sqlite3_value}
end

function sqlite3_column_bytes(arg1, iCol)
    @ccall libsqlite.sqlite3_column_bytes(arg1::Ptr{sqlite3_stmt}, iCol::Cint)::Cint
end

function sqlite3_column_bytes16(arg1, iCol)
    @ccall libsqlite.sqlite3_column_bytes16(arg1::Ptr{sqlite3_stmt}, iCol::Cint)::Cint
end

function sqlite3_column_type(arg1, iCol)
    @ccall libsqlite.sqlite3_column_type(arg1::Ptr{sqlite3_stmt}, iCol::Cint)::Cint
end
...
function sqlite3_create_function(db, zFunctionName, nArg, eTextRep, pApp, xFunc, xStep, xFinal)
...
function sqlite3_create_function16(db, zFunctionName, nArg, eTextRep, pApp, xFunc, xStep, xFinal)
...
function sqlite3_value_int64(arg1)
    @ccall libsqlite.sqlite3_value_int64(arg1::Ptr{sqlite3_value})::sqlite3_int64
end

function sqlite3_value_pointer(arg1, arg2)
    @ccall libsqlite.sqlite3_value_pointer(arg1::Ptr{sqlite3_value}, arg2::Ptr{Cchar})::Ptr{Cvoid}
end
...
function sqlite3_value_text16le(arg1)
    @ccall libsqlite.sqlite3_value_text16le(arg1::Ptr{sqlite3_value})::Ptr{Cvoid}
end

function sqlite3_value_text16be(arg1)
    @ccall libsqlite.sqlite3_value_text16be(arg1::Ptr{sqlite3_value})::Ptr{Cvoid}
end
...
function sqlite3_value_dup(arg1)
    @ccall libsqlite.sqlite3_value_dup(arg1::Ptr{sqlite3_value})::Ptr{sqlite3_value}
end
...
function sqlite3_aggregate_context(arg1, nBytes)
    @ccall libsqlite.sqlite3_aggregate_context(arg1::Ptr{sqlite3_context}, nBytes::Cint)::Ptr{Cvoid}
end
...
function sqlite3_context_db_handle(arg1)
    @ccall libsqlite.sqlite3_context_db_handle(arg1::Ptr{sqlite3_context})::Ptr{sqlite3}
end

function sqlite3_get_auxdata(arg1, N)
    @ccall libsqlite.sqlite3_get_auxdata(arg1::Ptr{sqlite3_context}, N::Cint)::Ptr{Cvoid}
end
...
function sqlite3_result_double(arg1, arg2)
    @ccall libsqlite.sqlite3_result_double(arg1::Ptr{sqlite3_context}, arg2::Cdouble)::Cvoid
end
...
function sqlite3_result_error_toobig(arg1)
    @ccall libsqlite.sqlite3_result_error_toobig(arg1::Ptr{sqlite3_context})::Cvoid
end

function sqlite3_result_error_nomem(arg1)
    @ccall libsqlite.sqlite3_result_error_nomem(arg1::Ptr{sqlite3_context})::Cvoid
end

function sqlite3_result_error_code(arg1, arg2)
    @ccall libsqlite.sqlite3_result_error_code(arg1::Ptr{sqlite3_context}, arg2::Cint)::Cvoid
end

function sqlite3_result_int(arg1, arg2)
    @ccall libsqlite.sqlite3_result_int(arg1::Ptr{sqlite3_context}, arg2::Cint)::Cvoid
end

function sqlite3_result_int64(arg1, arg2)
    @ccall libsqlite.sqlite3_result_int64(arg1::Ptr{sqlite3_context}, arg2::sqlite3_int64)::Cvoid
end
...
function sqlite3_result_zeroblob(arg1, n)
    @ccall libsqlite.sqlite3_result_zeroblob(arg1::Ptr{sqlite3_context}, n::Cint)::Cvoid
end

function sqlite3_result_zeroblob64(arg1, n)
    @ccall libsqlite.sqlite3_result_zeroblob64(arg1::Ptr{sqlite3_context}, n::sqlite3_uint64)::Cint
end

function sqlite3_result_subtype(arg1, arg2)
    @ccall libsqlite.sqlite3_result_subtype(arg1::Ptr{sqlite3_context}, arg2::Cuint)::Cvoid
end
...
function sqlite3_create_collation_v2(arg1, zName, eTextRep, pArg, xCompare, xDestroy)
...
function sqlite3_win32_set_directory(type, zValue)
    @ccall libsqlite.sqlite3_win32_set_directory(type::Culong, zValue::Ptr{Cvoid})::Cint
end

function sqlite3_win32_set_directory8(type, zValue)
    @ccall libsqlite.sqlite3_win32_set_directory8(type::Culong, zValue::Ptr{Cchar})::Cint
end

function sqlite3_win32_set_directory16(type, zValue)
    @ccall libsqlite.sqlite3_win32_set_directory16(type::Culong, zValue::Ptr{Cvoid})::Cint
end
...
function sqlite3_db_filename(db, zDbName)
    @ccall libsqlite.sqlite3_db_filename(db::Ptr{sqlite3}, zDbName::Ptr{Cchar})::Ptr{Cchar}
end

function sqlite3_db_readonly(db, zDbName)
    @ccall libsqlite.sqlite3_db_readonly(db::Ptr{sqlite3}, zDbName::Ptr{Cchar})::Cint
end

function sqlite3_txn_state(arg1, zSchema)
    @ccall libsqlite.sqlite3_txn_state(arg1::Ptr{sqlite3}, zSchema::Ptr{Cchar})::Cint
end
...
function sqlite3_enable_load_extension(db, onoff)
    @ccall libsqlite.sqlite3_enable_load_extension(db::Ptr{sqlite3}, onoff::Cint)::Cint
end
...
function sqlite3_cancel_auto_extension(xEntryPoint)
    @ccall libsqlite.sqlite3_cancel_auto_extension(xEntryPoint::Ptr{Cvoid})::Cint
end
...
function sqlite3_drop_modules(db, azKeep)
    @ccall libsqlite.sqlite3_drop_modules(db::Ptr{sqlite3}, azKeep::Ptr{Ptr{Cchar}})::Cint
end

function sqlite3_declare_vtab(arg1, zSQL)
    @ccall libsqlite.sqlite3_declare_vtab(arg1::Ptr{sqlite3}, zSQL::Ptr{Cchar})::Cint
end
...
function sqlite3_blob_reopen(arg1, arg2)
    @ccall libsqlite.sqlite3_blob_reopen(arg1::Ptr{sqlite3_blob}, arg2::sqlite3_int64)::Cint
end
...
function sqlite3_vfs_register(arg1, makeDflt)
    @ccall libsqlite.sqlite3_vfs_register(arg1::Ptr{sqlite3_vfs}, makeDflt::Cint)::Cint
end
...
function sqlite3_keyword_name(arg1, arg2, arg3)
    @ccall libsqlite.sqlite3_keyword_name(arg1::Cint, arg2::Ptr{Ptr{Cchar}}, arg3::Ptr{Cint})::Cint
end
...
function sqlite3_str_append(arg1, zIn, N)
    @ccall libsqlite.sqlite3_str_append(arg1::Ptr{sqlite3_str}, zIn::Ptr{Cchar}, N::Cint)::Cvoid
end

function sqlite3_str_appendall(arg1, zIn)
    @ccall libsqlite.sqlite3_str_appendall(arg1::Ptr{sqlite3_str}, zIn::Ptr{Cchar})::Cvoid
end

function sqlite3_str_appendchar(arg1, N, C)
    @ccall libsqlite.sqlite3_str_appendchar(arg1::Ptr{sqlite3_str}, N::Cint, C::Cchar)::Cvoid
end
...
function sqlite3_stmt_status(arg1, op, resetFlg)
    @ccall libsqlite.sqlite3_stmt_status(arg1::Ptr{sqlite3_stmt}, op::Cint, resetFlg::Cint)::Cint
end
...
function sqlite3_backup_step(p, nPage)
    @ccall libsqlite.sqlite3_backup_step(p::Ptr{sqlite3_backup}, nPage::Cint)::Cint
end
...
function sqlite3_strnicmp(arg1, arg2, arg3)
    @ccall libsqlite.sqlite3_strnicmp(arg1::Ptr{Cchar}, arg2::Ptr{Cchar}, arg3::Cint)::Cint
end
...
function sqlite3_strlike(zGlob, zStr, cEsc)
    @ccall libsqlite.sqlite3_strlike(zGlob::Ptr{Cchar}, zStr::Ptr{Cchar}, cEsc::Cuint)::Cint
end
...
function sqlite3_wal_checkpoint(db, zDb)
    @ccall libsqlite.sqlite3_wal_checkpoint(db::Ptr{sqlite3}, zDb::Ptr{Cchar})::Cint
end
...
function sqlite3_vtab_collation(arg1, arg2)
    @ccall libsqlite.sqlite3_vtab_collation(arg1::Ptr{sqlite3_index_info}, arg2::Cint)::Ptr{Cchar}
end
...
function sqlite3_stmt_scanstatus_reset(arg1)
    @ccall libsqlite.sqlite3_stmt_scanstatus_reset(arg1::Ptr{sqlite3_stmt})::Cvoid
end
...
function sqlite3_snapshot_recover(db, zDb)
    @ccall libsqlite.sqlite3_snapshot_recover(db::Ptr{sqlite3}, zDb::Ptr{Cchar})::Cint
end
...
function sqlite3_rtree_query_callback(db, zQueryFunc, xQueryFunc, pContext, xDestructor)
